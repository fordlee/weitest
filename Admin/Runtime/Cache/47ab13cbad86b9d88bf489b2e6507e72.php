...
<div class="main-content">
			...
			<div class="col-xs-12">
				<div class="row-fluid">
					<ul class="ace-thumbnails">
						...
						<?php if(is_array($item)): $i = 0; $__LIST__ = $item;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><li>
							<a href="<?php echo ($v["bgpic"]); ?>" data-rel="colorbox">
								<img alt="150x150" src="<?php echo ($v["icon"]); ?>"/>
								<div class="text">
	...
	<a href="#" id="btn-scroll-up" class="btn-scroll-up btn btn-sm btn-inverse">
		...
		<script src="__PUBLIC__/ace/assets/js/jquery.min.js"></script>
