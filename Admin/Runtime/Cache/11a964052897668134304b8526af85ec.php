			...
			<div class="col-xs-12">
				<form action="<?php echo U('edit');?>" method="post" class="form-horizontal" >
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" id="name" name="name" class="col-sm-6" value="<?php echo ($item["name"]); ?>"  />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="email">邮箱：</label>
						<div class="col-sm-10">
							<input type="text" id="email" name="email" class="col-sm-6" value="<?php echo ($item["email"]); ?>"  />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="password">密码：</label>
						<div class="col-sm-10">
							<input type="text" id="password" name="password" class="col-sm-6" value="<?php echo ($item["password"]); ?>" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="telphone">联系方式：</label>
						<div class="col-sm-10">
							<input type="text" id="telphone" name="telphone" class="col-sm-6" value="<?php echo ($item["telephone"]); ?>" />
						</div>
					</div>
