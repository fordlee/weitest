...
<div class="main-content">
	...
	<div class="page-content">
		<div class="page-header">
			<h1>
				<a href="<?php echo U('add');?>" class="btn btn-success pull-left">
					添加
				</a>
				<small></small>
			</h1>
		...
		<div class="row">
			<div class="col-xs-12">
				<table id="sample-table-1" class="table table-striped table-bordered table-hover">
					...
					<tbody>
						<?php if(is_array($adminlist)): $i = 0; $__LIST__ = $adminlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
								<td class="center"><?php echo ($v["name"]); ?></td>
								<td class="center"><?php echo ($v["email"]); ?></td>
								<td class="center"><?php echo ($v["telephone"]); ?></td>
								<td class="center">
									<a href="<?php echo U('edit');?>/id/<?php echo ($v["id"]); ?>">编辑</a>&nbsp;
									<a href="<?php echo U('del');?>/id/<?php echo ($v["id"]); ?>" onclick="return del()">删除</a>
								</td>
